...
if __name__ == '__main__':
    '''
    Below is the results of instance 1 in Table D.3 in the Appendix
    '''

    size = 5 # number of areas
    seed = 1 # instance random seed
    N = 100 # number of sample paths
    ride_generator = ridesharing_instance(size, 100) # 100 time periods
    ride_dm = ride_generator.generate_instance(seed)
