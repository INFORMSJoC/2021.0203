...
if __name__ == '__main__':
    '''
    below is the results of instance 1 in Table D.13 in the Appendix
    '''

    L = 2 # two-way exchange
    seed = 0

    dm = kidney_instance(200,10,24,seed).dm
    dm.generate_cycles(L=L)
    sim = simulator(dm, L=L)
    sim.run(100)
    print(sim.results)
